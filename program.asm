...
STARTING_POSITION EQU d'42'	;RAMI
...
INIT_MAZE		CALL	CLEARDISPLAY
				...
				;--PRINT ITR NUMBER
				MOVLW	d'9'
				SUBWF	ITERATIONS_COUNTER,0	; IF ITERATIONS < 10, 1ST DIGIT IS 0.
				BTFSC	STATUS,Z				; OTHERWISE IT'S 1
				GOTO	GREATER
				BTFSC	STATUS,C				
				GOTO	GREATER
				BTFSS	STATUS,C
...
GREATER			CALL	nb1
				...
				CALL	ET
				MOVLW	d'9'
				SUBWF	ITERATIONS_COUNTER,0
				GOTO	PRINT_ITERATIONS

SMALLER			CALL	nb0
				MOVLW	b'10011'
				CALL	ET
				INCF	ITERATIONS_COUNTER,0
				GOTO	PRINT_ITERATIONS
			
PRINT_ITERATIONS	IORLW	b'00010000'
					CALL	ET
...
SOLVED				CALL	PRINTPATH
					...
					MOVLW	b'10'
					MOVWF	SELECT
					CLRF	ITERATIONS_COUNTER
					GOTO	MENU
					

NOPATH				CALL	PRINTPATH
					CALL	letterX
					CALL	BUZZ
					CALL	CLEARDISPLAY
					CALL	CLEAR_REGISTERS
